...
// image default alt
if ( ! function_exists( 'real_estate_img_default_alt' ) ) {
	function real_estate_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'real_estate_img_tag' ) ) {
	function real_estate_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = real_estate_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'real_estate_anchor_tag' ) ) {
	function real_estate_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'real_estate_heading_tag' ) ) {
	function real_estate_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'real_estate_paragraph_tag' ) ) {
	function real_estate_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'real_estate_other_tag' ) ) {
	function real_estate_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'real_estate_button_element ' ) ) {
	function real_estate_button_element( array $args ) {
