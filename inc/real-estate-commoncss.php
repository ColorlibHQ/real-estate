...
// enqueue css
function real_estate_common_custom_css(){
    
    wp_enqueue_style( 'real_estate-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= real_estate_opt( 'real_estate_theme_color' ) != '#131313' ? real_estate_opt( 'real_estate_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= real_estate_opt( 'real_estate_book_btn_color' ) != '#131313' ? real_estate_opt('real_estate_book_btn_color') : '';
		$bookBtnHoverBgColor     	= real_estate_opt( 'real_estate_book_btn_hvr_bg_color' ) != '#131313' ? real_estate_opt('real_estate_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = real_estate_opt( 'real_estate_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = real_estate_opt( 'real_estate_navbar_bg_color' ) != '#082b49' ? real_estate_opt( 'real_estate_navbar_bg_color') : '';
		$headerTop_col     		  = real_estate_opt( 'real_estate_top_header_color' );

		$headerTopBg      		  = real_estate_opt( 'real_estate_top_header_bg_color');
		$headerBg          		  = real_estate_opt( 'real_estate_header_bg_color') != '#ffffff' ? real_estate_opt( 'real_estate_header_bg_color') : '';
		$menuColor          	  = real_estate_opt( 'real_estate_header_menu_color' ) != '#131313' ? real_estate_opt('real_estate_header_menu_color') : '';
		$menuHoverColor           = real_estate_opt( 'real_estate_header_menu_hover_color' ) != '#808080' ? real_estate_opt('real_estate_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = real_estate_opt( 'real_estate_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = real_estate_opt( 'real_estate_header_drop_menu_bg_color' ) != '#ffffff' ? real_estate_opt('real_estate_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = real_estate_opt( 'real_estate_dropdown_menu_color' ) != '#131313' ? real_estate_opt('real_estate_dropdown_menu_color') : '';
		$dropMenuHovColor         = real_estate_opt( 'real_estate_dropdown_menu_hover_color' ) != '#808080' ? real_estate_opt('real_estate_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = real_estate_opt( 'real_estate_footer_widget_bg_color' );
		$footerwHeadColor   	  = real_estate_opt('real_estate_footer_widget_heading_color');
		$footerwTextColor   	  = real_estate_opt('real_estate_footer_widget_text_color');
		$footerwanchorcolor 	  = real_estate_opt('real_estate_footer_widget_anchor_color') != '#ffffff' ? real_estate_opt('real_estate_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = real_estate_opt('real_estate_footer_widget_anchor_hover_color') != '#ffffff' ? real_estate_opt('real_estate_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = real_estate_opt('real_estate_fof_bg_color');
		$foftonecolor			  = real_estate_opt('real_estate_fof_textone_color');
		$fofttwocolor			  = real_estate_opt('real_estate_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = real_estate_opt('real_estate_footer_widget_anchor_color') != '#9e9e9e' ? real_estate_opt('real_estate_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .real_estate_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .real_estate_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'real_estate-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'real_estate_common_custom_css', 50 );